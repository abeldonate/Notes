...
c) \com{falta citar bien el articulo por el que $< = \le$ }
...
\end{minipage}
 ...
 c, d) Las homologías ordenadas serán exactamente igual que las homologías de posets del problema 1. 

 \com{calcular la homología orientada}
